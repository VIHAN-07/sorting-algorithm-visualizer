...
public class SortingPanel extends JPanel {
            ...
            Timer bubbleTimer = new Timer(10, new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    if (isSorted() || !isRunning) {
                        ...
                        if (isRunning) array = bubbleSort.sortOnlyOneItem();
                    }
                    repaint();
                }
            });
            ...
            Timer insertionTimer = new Timer(10, new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    if (isSorted() || !isRunning) {
                        ...
                        if (isRunning) array = insertionSort.sortOnlyOneItem();
                    }
                    repaint();
                }
            });
            ...
            Timer selectionTimer = new Timer(10, new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    if (isSorted() || !isRunning) {
                        ...
                        if (isRunning) array = selectionSort.sortOnlyOneItem();
                    }
                    repaint();
                }
            });
            ...
            Timer quickTimer = new Timer(10, new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    if (isSorted() || !isRunning) {
                        ...
                        if (isRunning) array = quickSort.sortOnlyOneItem();
                    }
                    repaint();
                }
            });
    ...
    public void paintComponent(Graphics g) {
        ...
        g.setColor(Color.CYAN); // Set the text color
        g.setFont(new Font("Arial", Font.BOLD, 24)); // Set the font and size
        g.drawString("Vihan-07", 20, 30); // Position the watermark at the top
